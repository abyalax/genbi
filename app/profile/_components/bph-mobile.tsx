...
export const BPHMobile = ({ BPH }: { BPH?: BPH }) => {
          ...
          <div className="flex flex-col gap-4 my-4">
            <div className="flex flex-col gap-1 justify-center items-center cursor-pointer">
              <svg
                ...
                width="100"
                height="100"
                className="w-10 h-10 xxs:w-12 xxs:h-12 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28"
                viewBox="0 0 24 24"
              >
          ...
          <div className="flex flex-col gap-4 my-4">
            <div className="flex flex-col gap-1 justify-center items-center cursor-pointer">
              <svg
                ...
                width="100"
                height="100"
                className="bi bi-briefcase-fill w-10 h-10 xxs:w-12 xxs:h-12 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28"
                viewBox="0 0 24 24"
              >
          ...
          <div className="flex flex-col gap-4 my-4">
            <div className="flex flex-col gap-1 justify-center items-center cursor-pointer">
              <svg
                ...
                width="100"
                height="100"
                className="bi bi-info-circle-fill w-10 h-10 xxs:w-12 xxs:h-12 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28"
                viewBox="0 0 16 16"
              >
          ...
          <div className="flex flex-col gap-4 my-4">
            <div className="flex flex-col gap-1 justify-center items-center cursor-pointer">
              <svg
                ...
                width="100"
                height="100"
                className="bi bi-people-fill w-10 h-10 xxs:w-12 xxs:h-12 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28"
                viewBox="0 0 16 16"
              >
