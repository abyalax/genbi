...
Migrate from this component ( this is from Inertia Laravel )
LandingPage.tsx
```tsx
...
export default function LandingPage({ news }: PageProps<{ news: News[] }>) {
    console.log({ news });
    ...
    return (
        <>
            <Head>
                ...
                <meta property="og:img" content="/assets/genbi/logo-genbi-polos.png" />
            ...
            <main className="bg-[#edf0f7] text-gray-700 min-h-screen min-w-screen px-0">
                <Navbar />
                {visible && (
                ...
                <section >
                    <div className="flex justify-center w-full" data-aos="fade-up">
                        <img src={"/assets/img/homepage.jpg"} alt="/assets/img/homepage.jpg" width={1000} height={600} className="w-3/4 mml:h-[50vh] rounded-xl object-cover object-center" />
                    </div>
                </section>
                ...
                <section className="lg:grid lg:grid-cols-2 mml:flex mml:flex-col gap-6 text-gray-800 px-6 sm:px-14 lg:px-32 ">
                    <div className="mml:col-span-1 sm:w-full flex gap-1" data-aos="fade-right">
                        <img src={"/assets/img/rapat.jpg"} alt="/assets/img/rapat.jpg" width={600} height={600} className=" w-2/3 rounded object-cover object-center" />
                        <img src={"/assets/img/rektor.jpg"} alt="/assets/img/rektor.jpg" width={800} height={600} className="w-1/3 rounded object-cover object-center" />
                    </div>
                        ...
                        <div className="mml:w-1/2 w-3/4" data-aos="fade-right">
                            <div className="relative h-[500px] sm:h-[450px] xs:h-[350px] xxs:h-[280px] bg-gradient-to-r from-[#1C8383] to-green-50 rounded-custom sm:pl-6 sm:pr-0 sm:pt-5 xxs:pl-4 xxs:pr-0 xxs:pt-3 xxs:pb-2 mml:pl-12 mml:pr-2 mml:pt-10 pl-6 pr-1 pt-5">
                                ...
                                <div className="relative bg-[#1C8383] w-full">
                                    <img alt="/assets/img/fotbar.jpg" src={"/assets/img/fotbar.jpg"} width={800} height={500} className="absolute w-full rounded-custom" />
                                </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-8">
                        ...
                        {news.map((e) => (
                            <div key={e.id} className="max-w-96 h-fit text-black">
                                {e.image && (
                                    <img alt={e.title} src={e.image as string} width={800} height={500} className="object-cover object-center rounded-lg" />
                                )}
