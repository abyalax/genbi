import { Facebook, ShareLink, Telegram, Twitter, WhatsApp } from "@/components/ui/share"
        ...
        <>
            ...
            <main className="min-w-[1080px]">
                ...
                <section className="w-4/5 mx-auto text-gray-700 pt-28">
                    <h2 className="text-4xl font-bold mx-20">{news.title}</h2>
                    <div className="flex justify-between gap-10 my-4 px-20">
                        <p>Oleh : {news.author_name}</p>
                        <div>
                    ...
                    <div className="w-full px-20">
                        <img src={news.image} alt="/assets/kegiatan/a.jpeg" width={1000} height={600} className="w-full h-[70vh] mx-auto object-cover object-center rounded-lg" />
                        <p className="border-l-2 border-red-500 italic pl-2 mt-2 mb-10">
                            {news.meta_description}
                        </p>
                    </div>
                    )}
                    <main className="grid grid-cols-8 pl-20">
                        <article className="col-span-6">
                            <div className="whitespace-pre-line text-justify ">
                                <QuillContent content={news.content} />
                            </div>
                        </article>
