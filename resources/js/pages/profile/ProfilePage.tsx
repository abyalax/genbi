            ...
            <main className="w-full bg-[#edf0f7] min-h-screen pt-24">
                ...
                <section className="lg:grid lg:grid-cols-2 mml:flex mml:flex-col gap-6 text-gray-800 px-6 sm:px-10 lg:px-32">
                    <div className="mml:col-span-1 sm:w-full flex gap-1" data-aos="fade-right">
                        <img src={"/assets/img/rapat.jpg"} width={500} height={500} alt="/assets/img/rapat.jpg" className=" w-2/3 rounded object-cover object-center" />
                        <img src={"/assets/img/rektor.jpg"} width={500} height={500} alt="/assets/img/rektor.jpg" className="w-1/3 rounded object-cover object-center" />
                    </div>
                ...
                <main className="flex flex-col justify-start items-center">
                    ...
                    <div className="flex gap-1 bg-[#1C8383] text-white sm:p-2 p-1.5 sm:rounded-full rounded-xl">
                        <img src={"/assets/dummy/1.jpg"} width={500} height={500} alt="dummy jpg" className="rounded-full w-14 h-14 object-cover object-center" />
                        <div onClick={() => router.visit(`/profile/${ketua[0].id}`)} className="cursor-pointer">
                    ...
                    <div className="flex gap-1 bg-[#1C8383] text-white sm:p-2 p-1.5 sm:rounded-full rounded-xl">
                        <img src={"/assets/dummy/2.jpg"} width={500} height={500} alt="/assets/dummy/2.jpg" className="rounded-full w-14 h-14 object-cover object-center" />
                        <div className="cursor-pointer" onClick={() => router.visit(`/profile/${wakilKetua[0].id}`)}>
                    ...
                    <div className="flex justify-around w-full">
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex gap-1 bg-[#1C8383] text-white py-2 pl-2 pr-4 sm:rounded-full rounded-xl">
                                <img src={"/assets/dummy/3.jpg"} width={500} height={500} alt="/assets/dummy/3.jpg" className="rounded-full w-14 h-14 object-cover object-center" />
                                <div className="cursor-pointer" onClick={() => router.visit(`/profile/${sekretaris.find((e) => e.jabatan === "Sekretaris 1")?.id}`)}>
                            ...
                            <div className="flex gap-1 bg-[#1C8383] text-white py-2 pl-2 pr-4 sm:rounded-full rounded-xl">
                                <img src={"/assets/dummy/4.jpg"} width={500} height={500} alt="/assets/dummy/4.jpg" className="rounded-full w-14 h-14 object-cover object-center" />
                                <div className="cursor-pointer" onClick={() => router.visit(`/profile/${sekretaris.find((e) => e.jabatan === "Sekretaris 2")?.id}`)}>
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex gap-1 bg-[#1C8383] text-white py-2 pl-2 pr-4 sm:rounded-full rounded-xl">
                                <img src={"/assets/dummy/5.jpg"} width={500} height={500} alt="/assets/dummy/5.jpg" className="rounded-full w-14 h-14 object-cover object-center" />
                                <div className="cursor-pointer" onClick={() => router.visit(`/profile/${bendahara.find((e) => e.jabatan === "Bendahara 1")?.id}`)}>
                            ...
                            <div className="flex gap-1 bg-[#1C8383] text-white py-2 pl-2 pr-4 sm:rounded-full rounded-xl">
                                <img src={"/assets/dummy/6.jpg"} width={500} height={500} alt="/assets/dummy/6.jpg" className="rounded-full w-14 h-14 object-cover object-center" />
                                <div className="cursor-pointer" onClick={() => router.visit(`/profile/${bendahara.find((e) => e.jabatan === "Bendahara 2")?.id}`)}>
    ...
    return (
        <section className="ml:block hidden mt-4">
            ...
            <div className="grid grid-cols-6 w-full items-start">
                ...
                <div onClick={() => router.visit(`/profile/divisi/${pendidikan.ketua.divisi_id}`)} className="col-span-1 flex flex-col gap-1 justify-center items-center cursor-pointer">
                ...
                <div onClick={() => router.visit(`/profile/divisi/${internasionalisasi.ketua.divisi_id}`)} className="col-span-1 flex flex-col gap-1 justify-center items-center cursor-pointer">
                ...
                <div onClick={() => router.visit(`/profile/divisi/${kewirausahaan.ketua.divisi_id}`)} className="col-span-1 flex flex-col gap-1 justify-center items-center cursor-pointer">
                ...
                <div onClick={() => router.visit(`/profile/divisi/${lingkungan.ketua.divisi_id}`)} className="col-span-1 flex flex-col gap-1 justify-center items-center cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#4B5563" width="100" height="100" className="w-8 h-8 xxs:w-10 xxs:h-10 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-24 lg:h-24" viewBox="0 0 24 24">
                ...
                <div onClick={() => router.visit(`/profile/divisi/${kominfo.ketua.divisi_id}`)} className="col-span-1 flex flex-col gap-1 justify-center items-center cursor-pointer">
                ...
                <div onClick={() => router.visit(`/profile/divisi/${pengabdian.ketua.divisi_id}`)} className="col-span-1 flex flex-col gap-1 justify-center items-center cursor-pointer">
